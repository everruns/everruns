...
| TM-AGENT-015 | Dangling tool calls cause LLM confusion | Low | A user message posted while a turn awaits client-side tool results explicitly cancels those calls before resuming the parked turn; transcript repair synthesizes any other missing results before an LLM call | MITIGATED |
