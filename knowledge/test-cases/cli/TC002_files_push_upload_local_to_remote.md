---
type: Test Case
title: "TC002: Files Push — Upload Local Files to Remote"
description: "Verify that `everruns files push` uploads local files to a session's workspace, supports dry-run, and tracks state for incremental sync."
tags:
  - everruns
  - test-case
  - cli
