---
type: Test Case
title: "TC005: Files Push — Delete Remote Files Not Present Locally"
description: "Verify that `everruns files push --delete` removes remote files that are no longer present locally, after an initial sync establishes the baseline."
tags:
  - everruns
  - test-case
  - cli
