---
type: Test Case
title: "TC003: Files Pull — Download Remote Files to Local"
description: "Verify that `everruns files pull` downloads session workspace files to a local directory, supports dry-run, and handles incremental sync."
tags:
  - everruns
  - test-case
  - cli
