---
type: Test Case
title: "TC006: Files Sync — Conflict Resolution"
description: "Verify that `everruns files sync` correctly detects and resolves conflicts when both local and remote versions of a file change between sync cycles."
tags:
  - everruns
  - test-case
  - cli
