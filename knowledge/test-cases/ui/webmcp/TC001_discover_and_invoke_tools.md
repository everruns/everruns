---
type: Test Case
title: "TC001: Discover and invoke WebMCP tools"
description: "Verifies that the authenticated Everruns UI registers its browser-native shell tools and that a browser agent can invoke read and navigation tools."
tags:
  - everruns
  - test-case
  - ui
