---
type: Test Case
title: "TC001: Admin Login - Success Login"
description: "Verify that an admin user can successfully log in when AUTH_MODE is set to admin and valid credentials are provided."
tags:
  - everruns
  - test-case
  - ui
