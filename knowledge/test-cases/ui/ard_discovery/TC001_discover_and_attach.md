---
type: Test Case
title: "TC001: ARD Discovery - Discover and Attach MCP Resource"
description: "Verify that an agent with the `resource_discovery` capability can discover an un-provisioned capability from an ARD registry, attach an MCP server via `attach_resource`, have the newly attached MCP tools (`mcp_<name>_..."
tags:
  - everruns
  - test-case
  - ui
