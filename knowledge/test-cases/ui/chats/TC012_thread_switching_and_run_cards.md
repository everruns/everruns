---
type: Test Case
title: "TC012: Chats - Thread Switching and Inline Run Cards"
description: "Verify that switching threads does not leak transcript state between them, and that a reply which started a run renders an inline run card in the turn that started it."
tags:
  - everruns
  - test-case
  - ui
