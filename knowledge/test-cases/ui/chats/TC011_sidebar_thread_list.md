---
type: Test Case
title: "TC011: Chats - Sidebar Thread List"
description: "Verify that the sidebar lists the most recently active threads under Chats, capped at five, and that the list does not re-order under the cursor while the pointer is inside it."
tags:
  - everruns
  - test-case
  - ui
