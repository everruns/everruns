---
type: Test Case
title: "TC015: Chats - Archive Chat"
description: "Verify that a chat can be archived and restored from both the Chats list and the open thread, that archived chats leave the default list and the sidebar, and that the **Show archived** filter brings them back without..."
tags:
  - everruns
  - test-case
  - ui
