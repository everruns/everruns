---
type: Test Case
title: "TC005: Global Chat - Run All 10 Agents"
description: "Verify that the global chat agent can run all 10 previously created agents sequentially, each with a relevant task, and relay all results."
tags:
  - everruns
  - test-case
  - ui
