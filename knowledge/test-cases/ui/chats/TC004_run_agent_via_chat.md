---
type: Test Case
title: "TC004: Global Chat - Run Agent via Chat"
description: "Verify that the global chat agent can run a previously created agent by creating a session, sending a message, waiting for completion, and relaying results."
tags:
  - everruns
  - test-case
  - ui
