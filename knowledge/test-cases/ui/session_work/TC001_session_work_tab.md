---
type: Test Case
title: "TC001: Session Work tab — tasks, leased resources and schedules"
description: "Verify the session **Work** tab (`/sessions/{sessionId}/work`) lists the background work *this* session started — subagent tasks, handoffs, background tools and monitors — updates chips live from `task.updated` withou..."
tags:
  - everruns
  - test-case
  - ui
