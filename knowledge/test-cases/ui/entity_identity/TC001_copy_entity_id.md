---
type: Test Case
title: "TC001: Copy an entity ID from the canonical identity line"
description: "Verifies that entity cards and detail headers keep the readable name primary while exposing a compact, accessible copy-ID action with the complete API-facing identifier."
tags:
  - everruns
  - test-case
  - ui
