---
type: Test Case
title: "TC008: Full Auth - Reachability Dead-End & Trap Recovery"
description: "Walk the scenarios the reachability model (`apps/ui/src/lib/auth-flow/machine.ts`) exists to protect: situations where a screen historically offered a way forward that silently no-ops or dead-ends for a particular hid..."
tags:
  - everruns
  - test-case
  - ui
