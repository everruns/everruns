---
type: Test Case
title: "TC007: Full Auth - OAuth Sign-in Error Paths"
description: "Verify OAuth (Google/GitHub) failure handling: the callback never dead-ends on raw JSON; the login door shows friendly copy per category."
tags:
  - everruns
  - test-case
  - ui
