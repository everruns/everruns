---
type: Test Case
title: "TC010: Full Auth - External Login Origin"
description: "Verify that protected routes can delegate the login page to a trusted remote origin while preserving a safe relative `return_to` continuation."
tags:
  - everruns
  - test-case
  - ui
