---
type: Test Case
title: "TC001: Create Organisation from Settings Page"
description: "Verify that a user can create a new organisation via the Settings > Organisation page and is redirected to the setup page."
tags:
  - everruns
  - test-case
  - ui
