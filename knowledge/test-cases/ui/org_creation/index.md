...
* [TC001: Create Organisation from Settings Page](TC001_create_org_from_settings.md) - Verify that a user can create a new organisation via the Settings > Organisation page and is redirected to the setup page.
* [TC002: Create Organisation from Sidebar Dropdown](TC002_create_org_from_sidebar.md) - Verify that a user can create a new organisation via the sidebar org dropdown.
* [TC003: Setup Page Shows Animated Progress](TC003_setup_page_progress.md) - Verify that the org setup page displays four sequential setup steps with animated completion, then offers the supported onboarding provider choices.
