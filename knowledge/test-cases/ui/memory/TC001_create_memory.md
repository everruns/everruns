---
type: Test Case
title: "TC001: Create Memory"
description: "Verify that a new workspace memory can be created from the Memory page and appears in the list with `active` status and a `mem_` prefixed ID."
tags:
  - everruns
  - test-case
  - ui
