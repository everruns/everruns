---
type: Test Case
title: "TC006: Memory Capability Mount Editor"
description: "Verify that the **Memory** capability config editor (on an agent or harness) lets users add, configure, and remove memory mounts, and surfaces inline validation for invalid paths, duplicate paths, and overlapping paths."
tags:
  - everruns
  - test-case
  - ui
