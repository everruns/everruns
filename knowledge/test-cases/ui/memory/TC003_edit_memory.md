---
type: Test Case
title: "TC003: Edit Memory Name and Description"
description: "Verify that an existing active memory's name and description can be edited from the memory card and that changes are reflected in both the list and detail views."
tags:
  - everruns
  - test-case
  - ui
