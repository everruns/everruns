---
type: Test Case
title: "TC004: Archive Memory and Toggle Archived Filter"
description: "Verify that a memory can be archived from the list, that archived memory are hidden by default, and that the archive filter toggle reveals them with a read-only `archived` badge and disabled write actions."
tags:
  - everruns
  - test-case
  - ui
