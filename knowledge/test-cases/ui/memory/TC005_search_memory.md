---
type: Test Case
title: "TC005: Search Memory by Name"
description: "Verify that the search input on the Memory page filters the list by name and surfaces the empty state when no memory match."
tags:
  - everruns
  - test-case
  - ui
