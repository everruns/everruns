---
type: Test Case
title: "TC002: Create Memory - Required Name Validation"
description: "Verify that the New Memory dialog rejects a whitespace-only name with an inline field error and does not create a memory."
tags:
  - everruns
  - test-case
  - ui
