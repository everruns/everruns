---
type: Test Case
title: "TC001: Local User Sidebar Actions"
description: "Verify the sidebar footer exposes actions supported by the current server capabilities in no-auth mode without presenting the local user as authenticated, and preserves the authenticated menu."
tags:
  - everruns
  - test-case
  - ui
