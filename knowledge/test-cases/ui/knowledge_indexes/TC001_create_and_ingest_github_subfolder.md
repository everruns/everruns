---
type: Test Case
title: "TC001: Create and ingest a GitHub subfolder"
description: "Verify that creating a knowledge index queues its initial sync, ingests documents from a GitHub subfolder, reports live state and counts, exposes failures, and can be retried without changing the configured model."
tags:
  - everruns
  - test-case
  - ui
