---
type: Test Case
title: "TC001: Personal Access Token User-Scoped Access"
description: "Verify that a personal access token created through the UI grants access to all organizations the user belongs to."
tags:
  - everruns
  - test-case
  - ui
