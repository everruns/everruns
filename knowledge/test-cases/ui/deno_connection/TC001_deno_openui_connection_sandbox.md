---
type: Test Case
title: "TC001: Deno OpenUI Connection - Sandbox Lifecycle"
description: "Verify that an agent with Deno capability prompts for a Deno access token via the inline OpenUI connection dialog when no connection exists, creates a sandbox after connecting, executes a command, and deletes the sand..."
tags:
  - everruns
  - test-case
  - ui
