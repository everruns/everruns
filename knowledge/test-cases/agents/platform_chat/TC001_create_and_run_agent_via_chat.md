---
type: Test Case
title: "TC001: Create and Run an Agent via Platform Chat"
description: "Verify that a user can use the Platform Chat global session to create a new agent end-to-end and then ask Platform Chat to invoke that agent — all from a single conversation."
tags:
  - everruns
  - test-case
  - agents
