---
type: Test Case
title: "TC003: Answer Platform Questions from Embedded Docs"
description: "Verify that Platform Chat answers a repo-specific product question by consulting the embedded platform docs mounted at `/workspace/docs`, not by relying only on generic model knowledge."
tags:
  - everruns
  - test-case
  - agents
