---
type: Test Case
title: "TC004: Create a Scheduled Agent via Platform Chat"
description: "Verify that Platform Chat can discover models and control-plane operations, create an Agent with an explicit default model, and create an Agent Trigger for recurring autonomous work."
tags:
  - everruns
  - test-case
  - agents
