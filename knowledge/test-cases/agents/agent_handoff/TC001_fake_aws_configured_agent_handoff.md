---
type: Test Case
title: "TC001: Fake AWS Configured Agent Handoff"
description: "Verify that a source agent with the `agent_handoff` capability can delegate an AWS-style request to a configured target Agent only after the user has a required Fake AWS connection."
tags:
  - everruns
  - test-case
  - agents
