---
type: Test Case
title: "TC001: Sales Analysis Workflow"
description: "Verify that an agent on the **Data Analyst** harness can load CSV data into a SQL database, analyze it, render a chart, and persist a correction to cross-session memory."
tags:
  - everruns
  - test-case
  - agents
