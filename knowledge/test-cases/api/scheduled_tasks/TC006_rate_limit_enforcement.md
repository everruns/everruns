---
type: Test Case
title: "TC006: Rate Limit Enforcement (Max Executions Per Hour)"
description: "Verify that the `max_executions_per_hour` rate limit (default: 1000) is enforced per organization."
tags:
  - everruns
  - test-case
  - api
