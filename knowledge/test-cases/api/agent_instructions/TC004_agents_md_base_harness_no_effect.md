---
type: Test Case
title: "TC004: AGENTS.md Has No Effect with Base Harness"
description: "Verify that AGENTS.md is not read when using the Base harness, which does not include the `agent_instructions` capability."
tags:
  - everruns
  - test-case
  - api
