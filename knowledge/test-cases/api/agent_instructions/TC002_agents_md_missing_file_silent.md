---
type: Test Case
title: "TC002: Missing AGENTS.md Silently Ignored"
description: "Verify that when no AGENTS.md file exists in the session filesystem, the agent operates normally without errors."
tags:
  - everruns
  - test-case
  - api
