---
type: Test Case
title: "TC001: AGENTS.md Applied via Generic Harness"
description: "Verify that AGENTS.md instructions are automatically applied when using the Generic harness (which includes `agent_instructions` capability by default)."
tags:
  - everruns
  - test-case
  - api
