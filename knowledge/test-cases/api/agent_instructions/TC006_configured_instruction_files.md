---
type: Test Case
title: "TC006: Configured Instruction Files"
description: "Verify that `agent_instructions` keeps `AGENTS.md` as the default and reads additional configured instruction files such as `CLAUDE.md`."
tags:
  - everruns
  - test-case
  - api
