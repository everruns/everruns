---
type: Test Case
title: "TC003: AGENTS.md Dynamic Update Between Turns"
description: "Verify that changes to AGENTS.md are picked up on the next turn without restarting the session."
tags:
  - everruns
  - test-case
  - api
