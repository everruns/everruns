---
type: Test Case
title: "TC001: OKF Import / Export Round-Trip"
description: "Verify a Knowledge Base round-trips through Open Knowledge Format (OKF): import a bundle of concept documents, confirm entries are created with the correct `kind`/`resource`/`tags`, confirm a re-import is idempotent (..."
tags:
  - everruns
  - test-case
  - api
