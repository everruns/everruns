---
type: Test Case
title: "TC003: Message Task - Send Follow-Up to Subagent"
description: "Verify that `message_task` can send a follow-up message to a subagent's task channel and that the subagent processes the message."
tags:
  - everruns
  - test-case
  - api
