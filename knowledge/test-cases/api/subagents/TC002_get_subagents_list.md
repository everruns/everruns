---
type: Test Case
title: "TC002: List Subagent Tasks After Spawning"
description: "Verify that after spawning multiple subagents, `list_tasks` (from the generic session_tasks capability) returns all subagent tasks with correct names, statuses, and count."
tags:
  - everruns
  - test-case
  - api
