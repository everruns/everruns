---
type: Test Case
title: "TC005: Cancel Task - Subagent Cancellation"
description: "Verify that `cancel_task` delivers a cooperative cancellation request to a subagent task and that the task transitions to a canceled state."
tags:
  - everruns
  - test-case
  - api
