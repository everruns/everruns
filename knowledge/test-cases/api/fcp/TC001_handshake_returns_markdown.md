---
type: Test Case
title: "TC001: FCP handshake (GET) returns Markdown"
description: "Verify that a `GET` on a published app's FCP endpoint returns the auto-generated Markdown handshake describing how to talk to the endpoint."
tags:
  - everruns
  - test-case
  - api
