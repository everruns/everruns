---
type: Test Case
title: "TC002: FCP POST plain text round-trip"
description: "Verify that posting plain text to the FCP endpoint produces a Markdown reply from the agent, sets the `fcp_session` cookie, and that a follow-up POST with that cookie resumes the same session."
tags:
  - everruns
  - test-case
  - api
