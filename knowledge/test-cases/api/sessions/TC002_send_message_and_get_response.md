---
type: Test Case
title: "TC002: Send Message and Get Response"
description: "Verify that sending a user message to a session triggers a turn, the agent responds, and the session transitions through correct states."
tags:
  - everruns
  - test-case
  - api
