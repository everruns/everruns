---
type: Test Case
title: "TC008: Session with Model Override"
description: "Verify that a session can override the agent's default model and that the override is used for responses."
tags:
  - everruns
  - test-case
  - api
