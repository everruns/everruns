---
type: Test Case
title: "TC005: Delete Agent - Archive and Hard Delete"
description: "Verify the two-stage agent deletion: soft delete (archive) via DELETE, then hard delete via POST /delete."
tags:
  - everruns
  - test-case
  - api
