---
type: Test Case
title: "TC004: Update Agent"
description: "Verify that an agent can be partially updated via PATCH, including name (slug) and display_name independently, and that only specified fields change."
tags:
  - everruns
  - test-case
  - api
