---
type: Test Case
title: "TC007: Check Agent Name Availability"
description: "Verify the `/v1/agents/check-name` endpoint correctly reports name availability, including format validation and exclude_id support for edit forms."
tags:
  - everruns
  - test-case
  - api
