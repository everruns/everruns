---
type: Test Case
title: "TC002: Create Agent - With Capabilities"
description: "Verify that an agent can be created with capabilities and that the capabilities are correctly stored and returned."
tags:
  - everruns
  - test-case
  - api
