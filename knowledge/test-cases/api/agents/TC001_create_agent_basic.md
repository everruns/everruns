---
type: Test Case
title: "TC001: Create Agent - Basic"
description: "Verify that an agent can be created with required fields (name, system_prompt) plus optional display_name, and returns a valid agent object with both name and display_name."
tags:
  - everruns
  - test-case
  - api
