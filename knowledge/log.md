...
* **Proposed retiring the App abstraction in favor of agent-owned exposure.**
  ...
  onto the endpoint id so nothing installed breaks. Recorded as a proposal, not a
  decision. See [Agent Exposure](integrations/agent-exposure.md).
