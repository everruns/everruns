...
| TypeSafe | [`integrations/typesafe/SPEC.md`](../../integrations/typesafe/SPEC.md) | Typed judgments (probability, single choice, graded score) via TypeSafe System One, as the `typesafe_evaluate` tool. Experimental (Dev only). The vendor client is the standalone [`crates/typesafe-systemone`](../../crates/typesafe-systemone/README.md) crate, which also backs the host's [Judgment Service](../operations/judgment-service.md). |
