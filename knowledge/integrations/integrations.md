...
| TypeSafe | [`integrations/typesafe/SPEC.md`](../../integrations/typesafe/SPEC.md) | Typed judgments (probability, single choice, graded score) via TypeSafe System One, as the `jev_evaluate` tool. Experimental (Dev only). The vendor client is the standalone [`crates/drivers/typesafe`](../../crates/drivers/typesafe/README.md) crate, which also backs the host's [Judgment Service](../operations/judgment-service.md). |
