...
const TOOL_REGISTRY: Record<string, ToolRegistryEntry> = {
  ...
  list_directory: { category: "read", segmentMode: "grouped" },
  stat_file: { category: "read", segmentMode: "grouped" },
  get_session_info: { category: "read", segmentMode: "grouped" },
  get_task: { category: "read", segmentMode: "grouped" },
  list_tasks: { category: "read", segmentMode: "grouped" },
  list_schedules: { category: "read", segmentMode: "grouped" },
  read_skill: { category: "read", segmentMode: "grouped" },
  list_skills: { category: "read", segmentMode: "grouped" },
  ...
  discover: { category: "search", segmentMode: "grouped" },
  query: { category: "search", segmentMode: "grouped" },
  ...
  write_skill: { category: "write", segmentMode: "grouped" },
  create_schedule: { category: "write", segmentMode: "grouped" },
  cancel_schedule: { category: "write", segmentMode: "grouped" },
  execute: { category: "tool", segmentMode: "grouped" },
  activate_skill: { category: "tool", segmentMode: "grouped" },
  spawn_background: { category: "tool", segmentMode: "grouped" },
  message_task: { category: "tool", segmentMode: "grouped" },
  cancel_task: { category: "tool", segmentMode: "grouped" },
  wait_task: { category: "tool", segmentMode: "grouped" },
