...
export default function DurableDashboardPage() {
  ...
  const stats = [
    ...
    {
      title: "Workflows",
      value: health?.started_workflows || 0,
      description: `${health?.running_workflows || 0} running, ${health?.completed_workflows || 0} completed`,
      icon: Workflow,
      color: "text-green-600",
    },
    {
      title: "Tasks",
      value: health?.started_tasks || 0,
      description: `${health?.pending_tasks || 0} pending, ${health?.claimed_tasks || 0} claimed`,
      icon: Clock,
