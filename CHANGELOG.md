...
- **Chat-centric UI** - Chats are now the landing surface with a thread list in the sidebar and a regrouped navigation (Chats · Operational · Building · Registries · Quality); session detail becomes a read-only recording you can Fork into a chat ([#3061](https://github.com/everruns/everruns/pull/3061), [#3057](https://github.com/everruns/everruns/pull/3057), [#3059](https://github.com/everruns/everruns/pull/3059)).
- **Secure MCP credential bindings** - MCP server connections can now bind credentials through a secure store instead of inline configuration ([#3051](https://github.com/everruns/everruns/pull/3051)).
- **Agent Plugins v1** - Plugins now support the Agent Plugins v1 format ([#2953](https://github.com/everruns/everruns/pull/2953)).
