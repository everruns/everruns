# Agent setup for `everruns`

This is a deepsec scanning workspace. Project `everruns` was just registered
(target: `..`). Setup is incomplete — `data/everruns/INFO.md`
...
2. **Fill in `data/everruns/INFO.md`.** It's auto-injected into the AI
...
pnpm deepsec process --project-id everruns
```
