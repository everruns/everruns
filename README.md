...
- **[MCP](https://docs.everruns.com/features/mcp/), both ways**: register remote MCP servers as virtual capabilities (auto-discovered and namespaced), and enable the authenticated MCP endpoint with OAuth 2.1 so other agents can call yours.
