...
use everruns_integrations_browserless::CAPABILITY_PLUGINS;
...
#[test]
fn test_browserless_plugin_is_published() {
    ...
    assert!(
        ...
        "Browserless IntegrationPlugin should be published in CAPABILITY_PLUGINS"
    );
}
