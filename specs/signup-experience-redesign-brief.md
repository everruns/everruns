...
Source of truth: `apps/ui/src/app/design-system.css` + `apps/ui/DESIGN.md` + `specs/brand.md`.
...
- `apps/ui/src/app/design-system.css`, `apps/ui/DESIGN.md`, `specs/brand.md`
...
- **Spec reversal** — contradicts `specs/propelauth-integration.md`, SaaS
  architecture/access-control; update those specs as part of the work.
