...
defined in [`specs/reporting.md`](reporting.md). Phase 3 only — not part of the
...
| Source keys | `event:<id>`, `session:<id>:turn:<id>`, `usage_ledger:<id>`, etc. (see [`specs/reporting.md`](reporting.md#idempotency)) |
