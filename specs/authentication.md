...
| `GITHUB_APP_ID` | GitHub App ID (numeric, for repo access connections) | - |
| `GITHUB_APP_PRIVATE_KEY` | GitHub App PEM-encoded RSA private key | - |
| `GITHUB_APP_SLUG` | GitHub App slug for installation URLs | `everruns` |
| `GITHUB_APP_SETUP_URL` | GitHub App setup/callback URL | `{AUTH_BASE_URL}{API_PREFIX}/v1/user/connections/github/callback` |
