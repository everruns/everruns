...
The Everruns MCP endpoint (`/mcp`, see [`specs/mcp.md`](mcp.md)) exposes
...
to remote MCP servers (covered in [`specs/mcp-servers.md`](mcp-servers.md)).
...
- `public_id` is the entity's external prefixed ID (e.g. `agent_01933b…`).
  See [`specs/id-schema.md`](id-schema.md).
...
- `type: "resource"` with a `resource.text` payload follows the MCP content
  type table in [`specs/mcp.md#content-types`](mcp.md#content-types).
...
[`specs/mcp.md#per-call-organization_id-override`](mcp.md#per-call-organization_id-override)).
...
See [`specs/threat-model.md`](threat-model.md) section *7b. MCP Server
