...
WORKSPACE_PIN_DEPS: list[str] = ["everruns-capability", "everruns-core", "everruns-engine", "everruns-host", "everruns-platform", "everruns-provider", "everruns-mcp", "everruns-local", "everruns-ard", "everruns", "everruns-macros"]
