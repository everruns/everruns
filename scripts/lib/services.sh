...
HTTP_ADDR_DEFAULT="0.0.0.0:${API_PORT}"
SERVER_GRPC_BIND_ADDR_DEFAULT="0.0.0.0:${WORKER_GRPC_PORT}"
SERVER_GRPC_ADDRESS_DEFAULT="127.0.0.1:${WORKER_GRPC_PORT}"
...
case "$cmd" in
  ...
  worker)
    ...
    export SERVER_GRPC_ADDRESS=${SERVER_GRPC_ADDRESS:-${WORKER_GRPC_ADDRESS:-$SERVER_GRPC_ADDRESS_DEFAULT}}
