...
echo "3/20 Cargo.lock freshness"
...
echo "7/20 Migration immutability"
...
echo "8/20 Server test enumeration"
...
echo "9/20 Public everruns examples"
...
echo "10/20 Knowledge bundle conformance"
if KNOWLEDGE_OUTPUT="$(
...
echo "11/20 Published crate documentation"
...
echo "12/20 Capability contract guard"
...
echo "13/20 Test-support isolation guard"
...
echo "14/20 Observability isolation guard"
...
echo "15/20 Agent-record isolation guard"
...
echo "16/20 Provider isolation guard"
...
echo "17/20 Environment capability isolation guard"
...
# 18. Hosted-capability isolation guard (EVE-885)
echo "18/20 Hosted-capability isolation guard"
...
# 19. Portable policy built-ins isolation guard (EVE-884)
echo "19/20 Portable built-ins isolation guard"
...
# 20. Commit author attribution check
echo "20/20 Commit author attribution"
