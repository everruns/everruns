...
echo "3/19 Cargo.lock freshness"
...
echo "7/19 Migration immutability"
...
echo "8/19 Server test enumeration"
...
echo "9/19 Public everruns examples"
...
echo "10/19 Knowledge bundle conformance"
if KNOWLEDGE_OUTPUT="$(
...
echo "11/19 Published crate documentation"
...
echo "12/19 Capability contract guard"
...
echo "13/19 Test-support isolation guard"
...
echo "14/19 Observability isolation guard"
...
echo "15/19 Agent-record isolation guard"
...
echo "16/19 Provider isolation guard"
...
echo "17/19 Environment capability isolation guard"
...
# 18. Portable policy built-ins isolation guard (EVE-884)
echo "18/19 Portable built-ins isolation guard"
...
# 19. Commit author attribution check
echo "19/19 Commit author attribution"
