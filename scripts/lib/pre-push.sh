...
echo "3/21 Cargo.lock freshness"
...
echo "7/21 Migration immutability"
...
echo "8/21 Server test enumeration"
...
echo "9/21 Public everruns examples"
...
echo "10/21 Knowledge bundle conformance"
if KNOWLEDGE_OUTPUT="$(
...
echo "11/21 Published crate documentation"
...
echo "12/21 Capability contract guard"
...
echo "13/21 Test-support isolation guard"
...
echo "14/21 Observability isolation guard"
...
echo "15/21 Agent-record isolation guard"
...
echo "16/21 Provider isolation guard"
...
echo "17/21 Core kernel dependency guard"
...
# 18. Effectful environment capability isolation guard (EVE-883)
echo "18/21 Environment capability isolation guard"
...
# 19. Hosted-capability isolation guard (EVE-885)
echo "19/21 Hosted-capability isolation guard"
...
# 20. Portable policy built-ins isolation guard (EVE-884)
echo "20/21 Portable built-ins isolation guard"
...
# 21. Commit author attribution check
echo "21/21 Commit author attribution"
