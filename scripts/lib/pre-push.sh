...
echo "17/23 Integration catalog guard"
...
echo "18/23 Core kernel dependency guard"
...
echo "19/23 Core public API guard"
...
echo "20/23 Environment capability isolation guard"
...
echo "21/23 Hosted-capability isolation guard"
...
echo "22/23 Portable built-ins isolation guard"
