...
echo "3/24 Cargo.lock freshness"
...
echo "7/24 Migration immutability"
...
echo "8/24 Server test enumeration"
...
echo "9/24 Public everruns examples"
...
echo "10/24 Knowledge bundle conformance"
if KNOWLEDGE_OUTPUT="$(
...
echo "11/24 Published crate documentation"
...
echo "12/24 Capability contract guard"
...
echo "13/24 Test-support isolation guard"
...
echo "14/24 Observability isolation guard"
...
echo "15/24 Agent-record isolation guard"
...
echo "16/24 Provider isolation guard"
...
echo "17/24 Integration catalog guard"
...
echo "18/24 Core kernel dependency guard"
...
echo "19/24 Core public API guard"
...
echo "20/24 Environment capability isolation guard"
...
echo "21/24 Hosted-capability isolation guard"
...
echo "22/24 Portable built-ins isolation guard"
...
echo "23/24 Source file size ratchet"
if FILE_SIZE_OUTPUT="$(
...
# 24. Commit author attribution check
echo "24/24 Commit author attribution"
