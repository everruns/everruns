...
Prefer a notebook-first setup? Start with [Run an Agent](/tutorials/run-an-agent/) for the smallest runnable SDK example, then come back here for the longer walkthrough.
