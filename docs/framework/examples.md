...
| [`agent_classification.rs`](https://github.com/everruns/everruns/blob/main/crates/everruns/examples/agent_classification.rs) | An agent that classifies with its own questions, offline by default | `cargo run -p everruns --features jev --example agent_classification` |
