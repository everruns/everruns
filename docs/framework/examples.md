...
| [`direct_judgment.rs`](https://github.com/everruns/everruns/blob/main/crates/everruns/examples/direct_judgment.rs) | Typed questions and calibrated answers with no agent, fully offline | `cargo run -p everruns --example direct_judgment` |
