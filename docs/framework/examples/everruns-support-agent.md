...
description: A two-step search/read tool interface, citable evidence, and an explicit boundary around the available knowledge.
---
...
![Everruns Support Agent recorded run](https://raw.githubusercontent.com/everruns/everruns/main/examples/everruns-support-agent/src/demo.gif)

Read the [captured transcript](https://github.com/everruns/everruns/blob/main/examples/everruns-support-agent/src/demo.txt) at your own pace. The GIF is a paginated
