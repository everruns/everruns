...
Projects are an opt-in feature flag. While it's off, everything lives in the default project and the switcher is hidden. See [Projects](/features/projects/) for turning them on and working in them.
