...
# Explicit slug: this .mdx page resolves through the symlinked docs/ dir to a
# real path, so starlight-links-validator can only register its headings under
# a stable route when the slug is pinned here. Without it, inbound links 404 in
# validation. Keep equal to the file-derived route.
slug: features/sdk
sidebar:
  label: SDK
---
