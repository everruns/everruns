...
<svg role="img" aria-label="OpenRouter logo" width="56" height="56" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg" style="float: right; margin-left: 16px;"><rect x="3" y="4.5" width="18" height="6" rx="1.2" stroke="currentColor" stroke-width="1.6"/><rect x="3" y="13.5" width="18" height="6" rx="1.2" stroke="currentColor" stroke-width="1.6"/><circle cx="6.8" cy="7.5" r="0.9" fill="currentColor"/><circle cx="6.8" cy="16.5" r="0.9" fill="currentColor"/></svg>
