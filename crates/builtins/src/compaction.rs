...
use everruns_core::compaction_policy::{
...
pub fn aggressive_trim(
    ...
    if protected_budget > token_budget {
        ...
        return crate::retain_complete_llm_tool_exchanges(result);
    }
    ...
    crate::retain_complete_llm_tool_exchanges(result)
}
...
pub fn compose_summary_with_recent(
    ...
    crate::retain_complete_llm_tool_exchanges(messages)
}
