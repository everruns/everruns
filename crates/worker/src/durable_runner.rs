...
pub struct DurableTurnInput {
    ...
    /// Turn ID - generated once when workflow starts, passed through all activities
    /// This ensures all events within a turn share the same turn_id
...
impl AgentRunner for DurableRunner {
    ...
    async fn start_run(
        ...
        // Generate turn_id once here - it will be passed through all activities
...
mod tests {
    ...
    #[test]
    fn test_durable_turn_input_deserialize_without_turn_id() {
        // Test backwards compatibility - old inputs without turn_id should still work
        // The #[serde(default)] will generate a new turn_id
        let json = r#"{
            "session_id": "01943f86-1234-7000-8000-000000000001",
            "agent_id": "01943f86-1234-7000-8000-000000000002",
            "input_message_id": "01943f86-1234-7000-8000-000000000003"
        }"#;

        let parsed: DurableTurnInput = serde_json::from_str(json).unwrap();
        // turn_id should be generated by the serde default
        assert!(!parsed.turn_id.is_nil());
    }
}
