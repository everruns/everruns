...
pub use adapters::{
    ...
    create_db_message_store, create_observable_agent_loop,
    create_observable_agent_loop_with_registry, create_openai_adapter,
    create_unified_tool_executor, create_unified_tool_executor_with_registry, DbEventEmitter,
    DbMessageStore, OpenAiLlmAdapter,
};
