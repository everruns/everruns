...
//! acquisition (`McpAuthProvider`), result mapping, and tool execution
//! (`McpExecutor`, which implements `everruns_core::McpToolInvoker` so MCP tools
//! register as regular `Tool`s). Wire types and tool-name helpers live in
