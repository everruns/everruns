...
mod tests {
    ...
    // =============================================================================
    //
    // These tests verify that our internal message format is correctly converted
    // to Braintrust-compatible (OpenAI) format.
    //
    // Internal format:          Braintrust/OpenAI format:
    ...
    fn test_convert_tool_result_message() {
        // Our internal "tool_result" role should become "tool" for Braintrust
