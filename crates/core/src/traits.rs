...
// ============================================================================
// MessageRetriever - For retrieving conversation messages
// ============================================================================
//
...
pub struct InputMessage {
    ...
    pub content: Vec<crate::message::ContentPart>,
    /// Runtime controls (model, reasoning, etc.)
    pub controls: Option<crate::message::Controls>,
...
impl InputMessage {
    ...
    pub fn user(content: impl Into<String>) -> Self {
        Self {
            ...
            content: vec![crate::message::ContentPart::text(content)],
            controls: None,
            metadata: None,
            tags: vec![],
        }
