...
pub const API_FEATURE_FLAG_DEFINITIONS: &[FeatureFlagDefinition] = &[
    FeatureFlagDefinition {
        name: "global_chat",
        label: "Global chat",
        description: "Adds a personal chat session you can open from the sidebar anywhere in the app. It's always available as a quick scratchpad to talk to your agents without first setting up a dedicated app or channel.",
        experimental: true,
    },
    FeatureFlagDefinition {
        name: "notifications",
        label: "Notifications",
        description: "Turns on the in-app notification bell, toasts, and live updates. You get alerted in real time when something you care about happens, instead of refreshing or checking back manually.",
        experimental: true,
    },
    FeatureFlagDefinition {
        name: "mcp_endpoint",
        label: "MCP server endpoint",
        description: "Lets Everruns act as an MCP server so external tools and assistants can connect to it. Other MCP-compatible clients can then reach your agents and data through a standard endpoint.",
        experimental: true,
    },
    FeatureFlagDefinition {
        name: "evals",
        label: "Evals",
        description: "Lets you define and run behavioral evals against your agents. Use it to confirm an agent responds the way you expect and to catch regressions as you change prompts or models.",
        experimental: true,
    },
    FeatureFlagDefinition {
        name: "app_budgets",
        label: "App budgets",
        description: "Adds spending limits scoped to individual apps and channels, with automatic resets on a schedule. It helps you cap and control costs so a single app or channel can't run away with your usage.",
        experimental: true,
    },
    FeatureFlagDefinition {
        name: "agent_versions",
        label: "Agent versions",
        description: "Captures immutable snapshots of your agents so you can fork, roll back, and pin apps to a specific version. This gives you a safety net to experiment freely and return to a known-good agent at any time.",
        experimental: true,
    },
    FeatureFlagDefinition {
        name: "voice",
        label: "Voice",
        description: "Enables realtime voice in chat with microphone controls. You can talk to your agents and hear responses instead of typing, for a hands-free conversation.",
        experimental: true,
    },
    FeatureFlagDefinition {
        name: "apps.detailV2",
        label: "Apps detail v2",
        description: "Switches the app detail page to a new channels-first layout with full-page forms for editing channels. It makes managing an app's channels clearer and gives you more room to work.",
        experimental: true,
    },
    FeatureFlagDefinition {
        name: "observers",
        label: "Observers",
        description: "Runs automatic online scoring on your production sessions. It continuously evaluates live conversations so you can monitor quality on real traffic without manually reviewing each one.",
        experimental: true,
    },
];
