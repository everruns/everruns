...
impl ManagementAction {
    pub fn as_str(&self) -> &'static str {
        match self {
            ...
            Self::ProviderCreated => "management.llm_provider.created",
            Self::ProviderUpdated => "management.llm_provider.updated",
            Self::ProviderDeleted => "management.llm_provider.deleted",
...
impl std::str::FromStr for ManagementAction {
    ...
    fn from_str(s: &str) -> Result<Self, Self::Err> {
        match s {
            ...
            "management.llm_provider.created" => Ok(Self::ProviderCreated),
            "management.llm_provider.updated" => Ok(Self::ProviderUpdated),
            "management.llm_provider.deleted" => Ok(Self::ProviderDeleted),
