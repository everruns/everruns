...
pub use capabilities::{
    ...
    SessionSandboxCapability, SessionSqlDatabaseCapability, SessionTitleMutation,
    SqlExecuteTool, SqlQueryTool, SqlSchemaTool, ToolCallHook, ToolDefinitionHook,
    WriteSessionTitleTool, apply_capabilities, collect_capabilities,
