...
// ============================================================================
// Event Snapshots (for replay optimization)
// ============================================================================

/// Current snapshot schema version.
/// Increment when the snapshot state format changes.
pub const SNAPSHOT_SCHEMA_VERSION: i32 = 1;

/// A snapshot of session state at a specific event sequence.
///
/// Snapshots enable faster replay by providing a checkpoint from which
/// to resume event processing instead of replaying from the beginning.
#[derive(Debug, Clone, Serialize, Deserialize)]
#[cfg_attr(feature = "openapi", derive(ToSchema))]
pub struct EventSnapshot {
    ...
    /// Event sequence number up to which this snapshot represents
    pub sequence: i32,

    /// Schema version for forward compatibility
    pub schema_version: i32,

    /// Serialized session state at this sequence
...
/// Request to create a new event snapshot.
#[derive(Debug, Clone, Serialize, Deserialize)]
#[cfg_attr(feature = "openapi", derive(ToSchema))]
pub struct EventSnapshotRequest {
    /// Session this snapshot belongs to
    pub session_id: Uuid,
    ...
    /// Schema version (defaults to SNAPSHOT_SCHEMA_VERSION if not specified)
...
impl EventSnapshotRequest {
    /// Create a new snapshot request
    pub fn new(session_id: Uuid, sequence: i32, state: serde_json::Value) -> Self {
        Self {
            session_id,
            sequence,
