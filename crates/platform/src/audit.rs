...
pub enum ManagementAction {
    ...
    MemberRemoved,
    MemberRoleChanged,
    // Invitations (OSS-owned org invites)
    InvitationCreated,
    InvitationRevoked,
    InvitationAccepted,
    // API keys
...
impl ManagementAction {
    pub fn as_str(&self) -> &'static str {
        match self {
            ...
            Self::InvitationCreated => "management.invitation.created",
            Self::InvitationRevoked => "management.invitation.revoked",
            Self::InvitationAccepted => "management.invitation.accepted",
            ...
            Self::ProviderCreated => "management.provider.created",
            Self::ProviderUpdated => "management.provider.updated",
            Self::ProviderDeleted => "management.provider.deleted",
...
impl std::str::FromStr for ManagementAction {
    ...
    fn from_str(s: &str) -> Result<Self, Self::Err> {
        match s {
            ...
            "management.invitation.created" => Ok(Self::InvitationCreated),
            "management.invitation.revoked" => Ok(Self::InvitationRevoked),
            "management.invitation.accepted" => Ok(Self::InvitationAccepted),
            ...
            "management.provider.created" => Ok(Self::ProviderCreated),
            "management.provider.updated" => Ok(Self::ProviderUpdated),
            "management.provider.deleted" => Ok(Self::ProviderDeleted),
