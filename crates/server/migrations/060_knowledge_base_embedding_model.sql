...
-- Resolves the open question in knowledge/runtime-resources/knowledge-bases.md: embedding-backed
...
COMMENT ON COLUMN knowledge_bases.embedding_model_id IS
    'Optional embedding model for hybrid retrieval. NULL = keyword search only. See knowledge/runtime-resources/knowledge-bases.md.';
