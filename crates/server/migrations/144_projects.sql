...
-- resources (agents, skills, apps, capabilities, MCP servers, sessions) belong
-- to exactly one project. Workspace-shared resources (harnesses, agent
-- identities, models, volumes, ...) stay org-scoped.
--
