...
pub const SKILL_VIEW: Policy = Policy {
    id: "skill.view",
    rules: &[Rule::UserHasPermission(Permission::OrgSkillsView)],
};
pub const SKILL_MANAGE: Policy = Policy {
    id: "skill.manage",
    rules: &[Rule::UserHasPermission(Permission::OrgSkillsManage)],
};
pub const SKILL_DANGEROUS: Policy = Policy {
    id: "skill.dangerous",
    rules: &[
        Rule::UserHasPermission(Permission::OrgSkillsManage),
